...
namespace KOPY {
	...
	static KO_KEY GetIndex(SDLK sdlKey)
	{
		...
		case SDLK::SDL_CAPSLOCK                : return KO_KEY::CAPSLOCK;
		case SDLK::SDL_F1                      : return KO_KEY::F1;
		case SDLK::SDL_F2                      : return KO_KEY::F2;
		case SDLK::SDL_F3                      : return KO_KEY::F3;
		case SDLK::SDL_F4                      : return KO_KEY::F4;
		case SDLK::SDL_F5                      : return KO_KEY::F5;
		case SDLK::SDL_F6                      : return KO_KEY::F6;
		case SDLK::SDL_F7                      : return KO_KEY::F7;
		case SDLK::SDL_F8                      : return KO_KEY::F8;
		case SDLK::SDL_F9                      : return KO_KEY::F9;
		case SDLK::SDL_F10                     : return KO_KEY::F10;
		case SDLK::SDL_F11                     : return KO_KEY::F11;
		case SDLK::SDL_F12                     : return KO_KEY::F12;
		case SDLK::SDL_PRINTSCREEN             : return KO_KEY::PRINTSCREEN;
		case SDLK::SDL_SCROLLLOCK              : return KO_KEY::SCROLLLOCK;
		case SDLK::SDL_PAUSE                   : return KO_KEY::PAUSE;
		case SDLK::SDL_INSERT                  : return KO_KEY::INSERT;
		case SDLK::SDL_HOME                    : return KO_KEY::HOME;
		case SDLK::SDL_PAGEUP                  : return KO_KEY::PAGEUP;
		case SDLK::SDL_END                     : return KO_KEY::END;
		case SDLK::SDL_PAGEDOWN                : return KO_KEY::PAGEDOWN;
		case SDLK::SDL_RIGHT                   : return KO_KEY::RIGHT;
		case SDLK::SDL_LEFT                    : return KO_KEY::LEFT;
		case SDLK::SDL_DOWN                    : return KO_KEY::DOWN;
		case SDLK::SDL_UP                      : return KO_KEY::UP;
		case SDLK::SDL_NUMLOCKCLEAR            : return KO_KEY::NUMLOCKCLEAR;
		case SDLK::SDL_KP_DIVIDE               : return KO_KEY::KP_DIVIDE;
		case SDLK::SDL_KP_MULTIPLY             : return KO_KEY::KP_MULTIPLY;
		case SDLK::SDL_KP_MINUS                : return KO_KEY::KP_MINUS;
		case SDLK::SDL_KP_PLUS                 : return KO_KEY::KP_PLUS;
		case SDLK::SDL_KP_ENTER                : return KO_KEY::KP_ENTER;
		case SDLK::SDL_KP_1                    : return KO_KEY::KP_1;
		case SDLK::SDL_KP_2                    : return KO_KEY::KP_2;
		case SDLK::SDL_KP_3                    : return KO_KEY::KP_3;
		case SDLK::SDL_KP_4                    : return KO_KEY::KP_4;
		case SDLK::SDL_KP_5                    : return KO_KEY::KP_5;
		case SDLK::SDL_KP_6                    : return KO_KEY::KP_6;
		case SDLK::SDL_KP_7                    : return KO_KEY::KP_7;
		case SDLK::SDL_KP_8                    : return KO_KEY::KP_8;
		case SDLK::SDL_KP_9                    : return KO_KEY::KP_9;
		case SDLK::SDL_KP_0                    : return KO_KEY::KP_0;
		case SDLK::SDL_KP_PERIOD               : return KO_KEY::KP_PERIOD;
		case SDLK::SDL_APPLICATION             : return KO_KEY::APPLICATION;
		case SDLK::SDL_POWER                   : return KO_KEY::POWER;
		case SDLK::SDL_KP_EQUALS               : return KO_KEY::KP_EQUALS;
		case SDLK::SDL_F13                     : return KO_KEY::F13;
		case SDLK::SDL_F14                     : return KO_KEY::F14;
		case SDLK::SDL_F15                     : return KO_KEY::F15;
		case SDLK::SDL_F16                     : return KO_KEY::F16;
		case SDLK::SDL_F17                     : return KO_KEY::F17;
		case SDLK::SDL_F18                     : return KO_KEY::F18;
		case SDLK::SDL_F19                     : return KO_KEY::F19;
		case SDLK::SDL_F20                     : return KO_KEY::F20;
		case SDLK::SDL_F21                     : return KO_KEY::F21;
		case SDLK::SDL_F22                     : return KO_KEY::F22;
		case SDLK::SDL_F23                     : return KO_KEY::F23;
		case SDLK::SDL_F24                     : return KO_KEY::F24;
		case SDLK::SDL_EXECUTE                 : return KO_KEY::EXECUTE;
		case SDLK::SDL_HELP                    : return KO_KEY::HELP;
		case SDLK::SDL_MENU                    : return KO_KEY::MENU;
		case SDLK::SDL_SELECT                  : return KO_KEY::SELECT;
		case SDLK::SDL_STOP                    : return KO_KEY::STOP;
		case SDLK::SDL_AGAIN                   : return KO_KEY::AGAIN;
		case SDLK::SDL_UNDO                    : return KO_KEY::UNDO;
		case SDLK::SDL_CUT                     : return KO_KEY::CUT;
		case SDLK::SDL_COPY                    : return KO_KEY::COPY;
		case SDLK::SDL_PASTE                   : return KO_KEY::PASTE;
		case SDLK::SDL_FIND                    : return KO_KEY::FIND;
		case SDLK::SDL_MUTE                    : return KO_KEY::MUTE;
		case SDLK::SDL_VOLUMEUP                : return KO_KEY::VOLUMEUP;
		case SDLK::SDL_VOLUMEDOWN              : return KO_KEY::VOLUMEDOWN;
		case SDLK::SDL_KP_COMMA                : return KO_KEY::KP_COMMA;
		case SDLK::SDL_KP_EQUALSAS400          : return KO_KEY::KP_EQUALSAS400;
		case SDLK::SDL_ALTERASE                : return KO_KEY::ALTERASE;
		case SDLK::SDL_SYSREQ                  : return KO_KEY::SYSREQ;
		case SDLK::SDL_CANCEL                  : return KO_KEY::CANCEL;
		case SDLK::SDL_CLEAR                   : return KO_KEY::CLEAR;
		case SDLK::SDL_PRIOR                   : return KO_KEY::PRIOR;
		case SDLK::SDL_RETURN2                 : return KO_KEY::RETURN2;
		case SDLK::SDL_SEPARATOR               : return KO_KEY::SEPARATOR;
		case SDLK::SDL_OUT_KEY                 : return KO_KEY::OUT_KEY;
		case SDLK::SDL_OPER                    : return KO_KEY::OPER;
		case SDLK::SDL_CLEARAGAIN              : return KO_KEY::CLEARAGAIN;
		case SDLK::SDL_CRSEL                   : return KO_KEY::CRSEL;
		case SDLK::SDL_EXSEL                   : return KO_KEY::EXSEL;
		case SDLK::SDL_KP_00                   : return KO_KEY::KP_00;
		case SDLK::SDL_KP_000                  : return KO_KEY::KP_000;
		case SDLK::SDL_THOUSANDSSEPARATOR      : return KO_KEY::THOUSANDSSEPARATOR;
		case SDLK::SDL_DECIMALSEPARATOR        : return KO_KEY::DECIMALSEPARATOR;
		case SDLK::SDL_CURRENCYUNIT            : return KO_KEY::CURRENCYUNIT;
		case SDLK::SDL_CURRENCYSUBUNIT         : return KO_KEY::CURRENCYSUBUNIT;
		case SDLK::SDL_KP_LEFTPAREN            : return KO_KEY::KP_LEFTPAREN;
		case SDLK::SDL_KP_RIGHTPAREN           : return KO_KEY::KP_RIGHTPAREN;
		case SDLK::SDL_KP_LEFTBRACE            : return KO_KEY::KP_LEFTBRACE;
		case SDLK::SDL_KP_RIGHTBRACE           : return KO_KEY::KP_RIGHTBRACE;
		case SDLK::SDL_KP_TAB                  : return KO_KEY::KP_TAB;
		case SDLK::SDL_KP_BACKSPACE            : return KO_KEY::KP_BACKSPACE;
		case SDLK::SDL_KP_A                    : return KO_KEY::KP_A;
		case SDLK::SDL_KP_B                    : return KO_KEY::KP_B;
		case SDLK::SDL_KP_C                    : return KO_KEY::KP_C;
		case SDLK::SDL_KP_D                    : return KO_KEY::KP_D;
		case SDLK::SDL_KP_E                    : return KO_KEY::KP_E;
		case SDLK::SDL_KP_F                    : return KO_KEY::KP_F;
		case SDLK::SDL_KP_XOR                  : return KO_KEY::KP_XOR;
		case SDLK::SDL_KP_POWER                : return KO_KEY::KP_POWER;
		case SDLK::SDL_KP_PERCENT              : return KO_KEY::KP_PERCENT;
		case SDLK::SDL_KP_LESS                 : return KO_KEY::KP_LESS;
		case SDLK::SDL_KP_GREATER              : return KO_KEY::KP_GREATER;
		case SDLK::SDL_KP_AMPERSAND            : return KO_KEY::KP_AMPERSAND;
		case SDLK::SDL_KP_DBLAMPERSAND         : return KO_KEY::KP_DBLAMPERSAND;
		case SDLK::SDL_KP_VERTICALBAR          : return KO_KEY::KP_VERTICALBAR;
		case SDLK::SDL_KP_DBLVERTICALBAR       : return KO_KEY::KP_DBLVERTICALBAR;
		case SDLK::SDL_KP_COLON                : return KO_KEY::KP_COLON;
		case SDLK::SDL_KP_HASH                 : return KO_KEY::KP_HASH;
		case SDLK::SDL_KP_SPACE                : return KO_KEY::KP_SPACE;
		case SDLK::SDL_KP_AT                   : return KO_KEY::KP_AT;
		case SDLK::SDL_KP_EXCLAM               : return KO_KEY::KP_EXCLAM;
		case SDLK::SDL_KP_MEMSTORE             : return KO_KEY::KP_MEMSTORE;
		case SDLK::SDL_KP_MEMRECALL            : return KO_KEY::KP_MEMRECALL;
		case SDLK::SDL_KP_MEMCLEAR             : return KO_KEY::KP_MEMCLEAR;
		case SDLK::SDL_KP_MEMADD               : return KO_KEY::KP_MEMADD;
		case SDLK::SDL_KP_MEMSUBTRACT          : return KO_KEY::KP_MEMSUBTRACT;
		case SDLK::SDL_KP_MEMMULTIPLY          : return KO_KEY::KP_MEMMULTIPLY;
		case SDLK::SDL_KP_MEMDIVIDE            : return KO_KEY::KP_MEMDIVIDE;
		case SDLK::SDL_KP_PLUSMINUS            : return KO_KEY::KP_PLUSMINUS;
		case SDLK::SDL_KP_CLEAR                : return KO_KEY::KP_CLEAR;
		case SDLK::SDL_KP_CLEARENTRY           : return KO_KEY::KP_CLEARENTRY;
		case SDLK::SDL_KP_BINARY               : return KO_KEY::KP_BINARY;
		case SDLK::SDL_KP_OCTAL                : return KO_KEY::KP_OCTAL;
		case SDLK::SDL_KP_DECIMAL              : return KO_KEY::KP_DECIMAL;
		case SDLK::SDL_KP_HEXADECIMAL          : return KO_KEY::KP_HEXADECIMAL;
		case SDLK::SDL_LCTRL                   : return KO_KEY::LCTRL;
		case SDLK::SDL_LSHIFT                  : return KO_KEY::LSHIFT;
		case SDLK::SDL_LALT                    : return KO_KEY::LALT;
		case SDLK::SDL_LGUI                    : return KO_KEY::LGUI;
		case SDLK::SDL_RCTRL                   : return KO_KEY::RCTRL;
		case SDLK::SDL_RSHIFT                  : return KO_KEY::RSHIFT;
		case SDLK::SDL_RALT                    : return KO_KEY::RALT;
		case SDLK::SDL_RGUI                    : return KO_KEY::RGUI;
		case SDLK::SDL_MODE                    : return KO_KEY::MODE;
		case SDLK::SDL_SLEEP                   : return KO_KEY::SLEEP;
		case SDLK::SDL_WAKE                    : return KO_KEY::WAKE;
		case SDLK::SDL_CHANNEL_INCREMENT       : return KO_KEY::CHANNEL_INCREMENT;
		case SDLK::SDL_CHANNEL_DECREMENT       : return KO_KEY::CHANNEL_DECREMENT;
		case SDLK::SDL_MEDIA_PLAY              : return KO_KEY::MEDIA_PLAY;
		case SDLK::SDL_MEDIA_PAUSE             : return KO_KEY::MEDIA_PAUSE;
		case SDLK::SDL_MEDIA_RECORD            : return KO_KEY::MEDIA_RECORD;
		case SDLK::SDL_MEDIA_FAST_FORWARD      : return KO_KEY::MEDIA_FAST_FORWARD;
		case SDLK::SDL_MEDIA_REWIND            : return KO_KEY::MEDIA_REWIND;
		case SDLK::SDL_MEDIA_NEXT_TRACK        : return KO_KEY::MEDIA_NEXT_TRACK;
		case SDLK::SDL_MEDIA_PREVIOUS_TRACK    : return KO_KEY::MEDIA_PREVIOUS_TRACK;
		case SDLK::SDL_MEDIA_STOP              : return KO_KEY::MEDIA_STOP;
		case SDLK::SDL_MEDIA_EJECT             : return KO_KEY::MEDIA_EJECT;
		case SDLK::SDL_MEDIA_PLAY_PAUSE        : return KO_KEY::MEDIA_PLAY_PAUSE;
		case SDLK::SDL_MEDIA_SELECT            : return KO_KEY::MEDIA_SELECT;
		case SDLK::SDL_AC_NEW                  : return KO_KEY::AC_NEW;
		case SDLK::SDL_AC_OPEN                 : return KO_KEY::AC_OPEN;
		case SDLK::SDL_AC_CLOSE                : return KO_KEY::AC_CLOSE;
		case SDLK::SDL_AC_EXIT                 : return KO_KEY::AC_EXIT;
		case SDLK::SDL_AC_SAVE                 : return KO_KEY::AC_SAVE;
		case SDLK::SDL_AC_PRINT                : return KO_KEY::AC_PRINT;
		case SDLK::SDL_AC_PROPERTIES           : return KO_KEY::AC_PROPERTIES;
		case SDLK::SDL_AC_SEARCH               : return KO_KEY::AC_SEARCH;
		case SDLK::SDL_AC_HOME                 : return KO_KEY::AC_HOME;
		case SDLK::SDL_AC_BACK                 : return KO_KEY::AC_BACK;
		case SDLK::SDL_AC_FORWARD              : return KO_KEY::AC_FORWARD;
		case SDLK::SDL_AC_STOP                 : return KO_KEY::AC_STOP;
		case SDLK::SDL_AC_REFRESH              : return KO_KEY::AC_REFRESH;
		case SDLK::SDL_AC_BOOKMARKS            : return KO_KEY::AC_BOOKMARKS;
		case SDLK::SDL_SOFTLEFT                : return KO_KEY::SOFTLEFT;
		case SDLK::SDL_SOFTRIGHT               : return KO_KEY::SOFTRIGHT;
		case SDLK::SDL_CALL                    : return KO_KEY::CALL;
		case SDLK::SDL_ENDCALL                 : return KO_KEY::ENDCALL;
		case SDLK::SDL_LEFT_TAB                : return KO_KEY::LEFT_TAB;
		case SDLK::SDL_LEVEL5_SHIFT            : return KO_KEY::LEVEL5_SHIFT;
		case SDLK::SDL_MULTI_KEY_COMPOSE       : return KO_KEY::MULTI_KEY_COMPOSE;
		case SDLK::SDL_LMETA                   : return KO_KEY::LMETA;
		case SDLK::SDL_RMETA                   : return KO_KEY::RMETA;
		case SDLK::SDL_LHYPER                  : return KO_KEY::LHYPER;
		case SDLK::SDL_RHYPER                  : return KO_KEY::RHYPER;
		}
	};
	static SDLK GetSDLK(KO_KEY koKey)
	{
		...
		case KO_KEY::CAPSLOCK					: return SDLK::SDL_CAPSLOCK;
		case KO_KEY::F1							: return SDLK::SDL_F1;
		case KO_KEY::F2							: return SDLK::SDL_F2;
		case KO_KEY::F3							: return SDLK::SDL_F3;
		case KO_KEY::F4							: return SDLK::SDL_F4;
		case KO_KEY::F5							: return SDLK::SDL_F5;
		case KO_KEY::F6							: return SDLK::SDL_F6;
		case KO_KEY::F7							: return SDLK::SDL_F7;
		case KO_KEY::F8							: return SDLK::SDL_F8;
		case KO_KEY::F9							: return SDLK::SDL_F9;
		case KO_KEY::F10						: return SDLK::SDL_F10;
		case KO_KEY::F11						: return SDLK::SDL_F11;
		case KO_KEY::F12						: return SDLK::SDL_F12;
		case KO_KEY::PRINTSCREEN				: return SDLK::SDL_PRINTSCREEN;
		case KO_KEY::SCROLLLOCK					: return SDLK::SDL_SCROLLLOCK;
		case KO_KEY::PAUSE						: return SDLK::SDL_PAUSE;
		case KO_KEY::INSERT						: return SDLK::SDL_INSERT;
		case KO_KEY::HOME						: return SDLK::SDL_HOME;
		case KO_KEY::PAGEUP						: return SDLK::SDL_PAGEUP;
		case KO_KEY::END						: return SDLK::SDL_END;
		case KO_KEY::PAGEDOWN					: return SDLK::SDL_PAGEDOWN;
		case KO_KEY::RIGHT						: return SDLK::SDL_RIGHT;
		case KO_KEY::LEFT						: return SDLK::SDL_LEFT;
		case KO_KEY::DOWN						: return SDLK::SDL_DOWN;
		case KO_KEY::UP							: return SDLK::SDL_UP;
		case KO_KEY::NUMLOCKCLEAR				: return SDLK::SDL_NUMLOCKCLEAR;
		case KO_KEY::KP_DIVIDE					: return SDLK::SDL_KP_DIVIDE;
		case KO_KEY::KP_MULTIPLY				: return SDLK::SDL_KP_MULTIPLY;
		case KO_KEY::KP_MINUS					: return SDLK::SDL_KP_MINUS;
		case KO_KEY::KP_PLUS					: return SDLK::SDL_KP_PLUS;
		case KO_KEY::KP_ENTER					: return SDLK::SDL_KP_ENTER;
		case KO_KEY::KP_1						: return SDLK::SDL_KP_1;
		case KO_KEY::KP_2						: return SDLK::SDL_KP_2;
		case KO_KEY::KP_3						: return SDLK::SDL_KP_3;
		case KO_KEY::KP_4						: return SDLK::SDL_KP_4;
		case KO_KEY::KP_5						: return SDLK::SDL_KP_5;
		case KO_KEY::KP_6						: return SDLK::SDL_KP_6;
		case KO_KEY::KP_7						: return SDLK::SDL_KP_7;
		case KO_KEY::KP_8						: return SDLK::SDL_KP_8;
		case KO_KEY::KP_9						: return SDLK::SDL_KP_9;
		case KO_KEY::KP_0						: return SDLK::SDL_KP_0;
		case KO_KEY::KP_PERIOD					: return SDLK::SDL_KP_PERIOD;
		case KO_KEY::APPLICATION				: return SDLK::SDL_APPLICATION;
		case KO_KEY::POWER						: return SDLK::SDL_POWER;
		case KO_KEY::KP_EQUALS					: return SDLK::SDL_KP_EQUALS;
		case KO_KEY::F13						: return SDLK::SDL_F13;
		case KO_KEY::F14						: return SDLK::SDL_F14;
		case KO_KEY::F15						: return SDLK::SDL_F15;
		case KO_KEY::F16						: return SDLK::SDL_F16;
		case KO_KEY::F17						: return SDLK::SDL_F17;
		case KO_KEY::F18						: return SDLK::SDL_F18;
		case KO_KEY::F19						: return SDLK::SDL_F19;
		case KO_KEY::F20						: return SDLK::SDL_F20;
		case KO_KEY::F21						: return SDLK::SDL_F21;
		case KO_KEY::F22						: return SDLK::SDL_F22;
		case KO_KEY::F23						: return SDLK::SDL_F23;
		case KO_KEY::F24						: return SDLK::SDL_F24;
		case KO_KEY::EXECUTE					: return SDLK::SDL_EXECUTE;
		case KO_KEY::HELP						: return SDLK::SDL_HELP;
		case KO_KEY::MENU						: return SDLK::SDL_MENU;
		case KO_KEY::SELECT						: return SDLK::SDL_SELECT;
		case KO_KEY::STOP						: return SDLK::SDL_STOP;
		case KO_KEY::AGAIN						: return SDLK::SDL_AGAIN;
		case KO_KEY::UNDO						: return SDLK::SDL_UNDO;
		case KO_KEY::CUT						: return SDLK::SDL_CUT;
		case KO_KEY::COPY						: return SDLK::SDL_COPY;
		case KO_KEY::PASTE						: return SDLK::SDL_PASTE;
		case KO_KEY::FIND						: return SDLK::SDL_FIND;
		case KO_KEY::MUTE						: return SDLK::SDL_MUTE;
		case KO_KEY::VOLUMEUP					: return SDLK::SDL_VOLUMEUP;
		case KO_KEY::VOLUMEDOWN					: return SDLK::SDL_VOLUMEDOWN;
		case KO_KEY::KP_COMMA					: return SDLK::SDL_KP_COMMA;
		case KO_KEY::KP_EQUALSAS400				: return SDLK::SDL_KP_EQUALSAS400;
		case KO_KEY::ALTERASE					: return SDLK::SDL_ALTERASE;
		case KO_KEY::SYSREQ						: return SDLK::SDL_SYSREQ;
		case KO_KEY::CANCEL						: return SDLK::SDL_CANCEL;
		case KO_KEY::CLEAR						: return SDLK::SDL_CLEAR;
		case KO_KEY::PRIOR						: return SDLK::SDL_PRIOR;
		case KO_KEY::RETURN2					: return SDLK::SDL_RETURN2;
		case KO_KEY::SEPARATOR					: return SDLK::SDL_SEPARATOR;
		case KO_KEY::OUT_KEY					: return SDLK::SDL_OUT_KEY;
		case KO_KEY::OPER						: return SDLK::SDL_OPER;
		case KO_KEY::CLEARAGAIN					: return SDLK::SDL_CLEARAGAIN;
		case KO_KEY::CRSEL						: return SDLK::SDL_CRSEL;
		case KO_KEY::EXSEL						: return SDLK::SDL_EXSEL;
		case KO_KEY::KP_00						: return SDLK::SDL_KP_00;
		case KO_KEY::KP_000						: return SDLK::SDL_KP_000;
		case KO_KEY::THOUSANDSSEPARATOR			: return SDLK::SDL_THOUSANDSSEPARATOR;
		case KO_KEY::DECIMALSEPARATOR			: return SDLK::SDL_DECIMALSEPARATOR;
		case KO_KEY::CURRENCYUNIT				: return SDLK::SDL_CURRENCYUNIT;
		case KO_KEY::CURRENCYSUBUNIT			: return SDLK::SDL_CURRENCYSUBUNIT;
		case KO_KEY::KP_LEFTPAREN				: return SDLK::SDL_KP_LEFTPAREN;
		case KO_KEY::KP_RIGHTPAREN				: return SDLK::SDL_KP_RIGHTPAREN;
		case KO_KEY::KP_LEFTBRACE				: return SDLK::SDL_KP_LEFTBRACE;
		case KO_KEY::KP_RIGHTBRACE				: return SDLK::SDL_KP_RIGHTBRACE;
		case KO_KEY::KP_TAB						: return SDLK::SDL_KP_TAB;
		case KO_KEY::KP_BACKSPACE				: return SDLK::SDL_KP_BACKSPACE;
		case KO_KEY::KP_A						: return SDLK::SDL_KP_A;
		case KO_KEY::KP_B						: return SDLK::SDL_KP_B;
		case KO_KEY::KP_C						: return SDLK::SDL_KP_C;
		case KO_KEY::KP_D						: return SDLK::SDL_KP_D;
		case KO_KEY::KP_E						: return SDLK::SDL_KP_E;
		case KO_KEY::KP_F						: return SDLK::SDL_KP_F;
		case KO_KEY::KP_XOR						: return SDLK::SDL_KP_XOR;
		case KO_KEY::KP_POWER					: return SDLK::SDL_KP_POWER;
		case KO_KEY::KP_PERCENT					: return SDLK::SDL_KP_PERCENT;
		case KO_KEY::KP_LESS					: return SDLK::SDL_KP_LESS;
		case KO_KEY::KP_GREATER					: return SDLK::SDL_KP_GREATER;
		case KO_KEY::KP_AMPERSAND				: return SDLK::SDL_KP_AMPERSAND;
		case KO_KEY::KP_DBLAMPERSAND			: return SDLK::SDL_KP_DBLAMPERSAND;
		case KO_KEY::KP_VERTICALBAR				: return SDLK::SDL_KP_VERTICALBAR;
		case KO_KEY::KP_DBLVERTICALBAR			: return SDLK::SDL_KP_DBLVERTICALBAR;
		case KO_KEY::KP_COLON					: return SDLK::SDL_KP_COLON;
		case KO_KEY::KP_HASH					: return SDLK::SDL_KP_HASH;
		case KO_KEY::KP_SPACE					: return SDLK::SDL_KP_SPACE;
		case KO_KEY::KP_AT						: return SDLK::SDL_KP_AT;
		case KO_KEY::KP_EXCLAM					: return SDLK::SDL_KP_EXCLAM;
		case KO_KEY::KP_MEMSTORE				: return SDLK::SDL_KP_MEMSTORE;
		case KO_KEY::KP_MEMRECALL				: return SDLK::SDL_KP_MEMRECALL;
		case KO_KEY::KP_MEMCLEAR				: return SDLK::SDL_KP_MEMCLEAR;
		case KO_KEY::KP_MEMADD					: return SDLK::SDL_KP_MEMADD;
		case KO_KEY::KP_MEMSUBTRACT				: return SDLK::SDL_KP_MEMSUBTRACT;
		case KO_KEY::KP_MEMMULTIPLY				: return SDLK::SDL_KP_MEMMULTIPLY;
		case KO_KEY::KP_MEMDIVIDE				: return SDLK::SDL_KP_MEMDIVIDE;
		case KO_KEY::KP_PLUSMINUS				: return SDLK::SDL_KP_PLUSMINUS;
		case KO_KEY::KP_CLEAR					: return SDLK::SDL_KP_CLEAR;
		case KO_KEY::KP_CLEARENTRY				: return SDLK::SDL_KP_CLEARENTRY;
		case KO_KEY::KP_BINARY					: return SDLK::SDL_KP_BINARY;
		case KO_KEY::KP_OCTAL					: return SDLK::SDL_KP_OCTAL;
		case KO_KEY::KP_DECIMAL					: return SDLK::SDL_KP_DECIMAL;
		case KO_KEY::KP_HEXADECIMAL				: return SDLK::SDL_KP_HEXADECIMAL;
		case KO_KEY::LCTRL						: return SDLK::SDL_LCTRL;
		case KO_KEY::LSHIFT						: return SDLK::SDL_LSHIFT;
		case KO_KEY::LALT						: return SDLK::SDL_LALT;
		case KO_KEY::LGUI						: return SDLK::SDL_LGUI;
		case KO_KEY::RCTRL						: return SDLK::SDL_RCTRL;
		case KO_KEY::RSHIFT						: return SDLK::SDL_RSHIFT;
		case KO_KEY::RALT						: return SDLK::SDL_RALT;
		case KO_KEY::RGUI						: return SDLK::SDL_RGUI;
		case KO_KEY::MODE						: return SDLK::SDL_MODE;
		case KO_KEY::SLEEP						: return SDLK::SDL_SLEEP;
		case KO_KEY::WAKE						: return SDLK::SDL_WAKE;
		case KO_KEY::CHANNEL_INCREMENT			: return SDLK::SDL_CHANNEL_INCREMENT;
		case KO_KEY::CHANNEL_DECREMENT			: return SDLK::SDL_CHANNEL_DECREMENT;
		case KO_KEY::MEDIA_PLAY					: return SDLK::SDL_MEDIA_PLAY;
		case KO_KEY::MEDIA_PAUSE				: return SDLK::SDL_MEDIA_PAUSE;
		case KO_KEY::MEDIA_RECORD				: return SDLK::SDL_MEDIA_RECORD;
		case KO_KEY::MEDIA_FAST_FORWARD			: return SDLK::SDL_MEDIA_FAST_FORWARD;
		case KO_KEY::MEDIA_REWIND				: return SDLK::SDL_MEDIA_REWIND;
		case KO_KEY::MEDIA_NEXT_TRACK			: return SDLK::SDL_MEDIA_NEXT_TRACK;
		case KO_KEY::MEDIA_PREVIOUS_TRACK		: return SDLK::SDL_MEDIA_PREVIOUS_TRACK;
		case KO_KEY::MEDIA_STOP					: return SDLK::SDL_MEDIA_STOP;
		case KO_KEY::MEDIA_EJECT				: return SDLK::SDL_MEDIA_EJECT;
		case KO_KEY::MEDIA_PLAY_PAUSE			: return SDLK::SDL_MEDIA_PLAY_PAUSE;
		case KO_KEY::MEDIA_SELECT				: return SDLK::SDL_MEDIA_SELECT;
		case KO_KEY::AC_NEW						: return SDLK::SDL_AC_NEW;
		case KO_KEY::AC_OPEN					: return SDLK::SDL_AC_OPEN;
		case KO_KEY::AC_CLOSE					: return SDLK::SDL_AC_CLOSE;
		case KO_KEY::AC_EXIT					: return SDLK::SDL_AC_EXIT;
		case KO_KEY::AC_SAVE					: return SDLK::SDL_AC_SAVE;
		case KO_KEY::AC_PRINT					: return SDLK::SDL_AC_PRINT;
		case KO_KEY::AC_PROPERTIES				: return SDLK::SDL_AC_PROPERTIES;
		case KO_KEY::AC_SEARCH					: return SDLK::SDL_AC_SEARCH;
		case KO_KEY::AC_HOME					: return SDLK::SDL_AC_HOME;
		case KO_KEY::AC_BACK					: return SDLK::SDL_AC_BACK;
		case KO_KEY::AC_FORWARD					: return SDLK::SDL_AC_FORWARD;
		case KO_KEY::AC_STOP					: return SDLK::SDL_AC_STOP;
		case KO_KEY::AC_REFRESH					: return SDLK::SDL_AC_REFRESH;
		case KO_KEY::AC_BOOKMARKS				: return SDLK::SDL_AC_BOOKMARKS;
		case KO_KEY::SOFTLEFT					: return SDLK::SDL_SOFTLEFT;
		case KO_KEY::SOFTRIGHT					: return SDLK::SDL_SOFTRIGHT;
		case KO_KEY::CALL						: return SDLK::SDL_CALL;
		case KO_KEY::ENDCALL					: return SDLK::SDL_ENDCALL;
		case KO_KEY::LEFT_TAB					: return SDLK::SDL_LEFT_TAB;
		case KO_KEY::LEVEL5_SHIFT				: return SDLK::SDL_LEVEL5_SHIFT;
		case KO_KEY::MULTI_KEY_COMPOSE			: return SDLK::SDL_MULTI_KEY_COMPOSE;
		case KO_KEY::LMETA						: return SDLK::SDL_LMETA;
		case KO_KEY::RMETA						: return SDLK::SDL_RMETA;
		case KO_KEY::LHYPER						: return SDLK::SDL_LHYPER;
		case KO_KEY::RHYPER						: return SDLK::SDL_RHYPER;
